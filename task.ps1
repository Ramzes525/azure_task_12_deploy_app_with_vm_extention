...
$Params = @{
    ...
    ProtectedSettings  = @{ fileUris = @("https://raw.githubusercontent.com/Ramzes525/azure_task_12_deploy_app_with_vm_extention/develop/install-app.sh"); commandToExecute = "sh install-app.sh"}
}
